...
use crate::{
    ...
    ScalePagesOptions, SignatureAddOptions, SignatureDeleteFieldOptions, SignatureMode,
    SignatureOptions, SinglePageOptions, SplitOptions, SvgToPdfOptions, TimestampAddOptions,
    WatermarkOptions, add_pdf_signature, add_pdf_timestamp, booklet_pdf_pages_with_limits,
    compare_pdf_report, compare_pdf_visual_diff, decrypt_pdf, delete_pdf_signature_field,
    ...
    verify_pdf_signatures, watermark_pdf_artifacts,
};
