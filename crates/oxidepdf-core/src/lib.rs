...
pub(crate) use pdf_io::{
    ...
    ensure_pdf_magic, load_pdf, map_pdf_extract_error, rebuild_pages_tree, resource_limit,
    save_pdf,
};

pub use compare::PdfCompareOptions;
pub use overlay::{
    ExtractTextOptions, ImageToPdfOptions, RenderOptions, SvgToPdfOptions, WatermarkKind,
    WatermarkOptions,
};
pub use page_ops::{
